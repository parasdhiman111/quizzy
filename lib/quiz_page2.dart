  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context,snapshot)
      {
        ...
        {
          return QuizData2(myData: myData);
        }
      },
    );
  }
...
class QuizData2 extends StatefulWidget {

  var myData;

  QuizData2({Key key,@required this.myData}):super(key: key);

  @override
  _QuizDataState2 createState() => _QuizDataState2(myData);
}

class _QuizDataState2 extends State<QuizData2> {

  var myData;
  _QuizDataState2(this.myData);
